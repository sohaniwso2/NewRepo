...
/**
 * By using the input schema, output schema and mapping configuration, DataMapperMediator generates the output 
 * required by the next mediator for the input received by the previous mediator.
 */
public class DataMapperMediator extends AbstractMediator {

	/*
	 * private static final String START_MESSAGE =
	 * Messages.DataMapperMediator_startMessage; private static final String
	 * MESSAGE = Messages.DataMapperMediator_message; private static final
	 * String COMPLETE_MESSAGE = Messages.DataMapperMediator_completeMessage;
	 * private static final String DESTROY_MESSAGE =
	 * Messages.DataMapperMediator_destroyMessage; private static final String
	 * INITIALIZED_MESSAGE = Messages.DataMapperMediator_initializedMessage;
	 */
	 ...
	 * 
	 * @param the current message for mediation
	...
	public boolean mediate(MessageContext messageContext) {
		...
		if (!(StringUtils.isNotEmpty(configkey) && StringUtils.isNotEmpty(inSchemaKey) && StringUtils.isNotEmpty(outSchemaKey))) {
			LogFactory.getLog(this.getClass()).error("Invalid configurations for the DataMapperMediator");
			result = false;
		}
		...
		try {
			...
			LogFactory.getLog(this.getClass()).error("Mediation faild at DataMapperMediator");
			result = false;
		}
