...
public class DataMapperMediatorFactory extends AbstractMediatorFactory {
     ...
     *
     * @return QName specifying the DataMapperMediator tag name of the xml configuration
     */
	@Override
	public QName getTagQName() {
	 ...
	 /**
     * This method will create the DataMapperMediator by parsing the given xml configuration
     *
     * @param element OMElement describing the configuration of the DataMapperMediator
