...
/**
 * 
 * A wrapper class to wrap MappingResourceLoader with the first acessed time
 *
 */
public class CachedMappingResourceLoader {
	...
	public CachedMappingResourceLoader(Date dateTime, MappingResourceLoader mappingResourceLoader) {
